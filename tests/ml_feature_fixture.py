"""Backend↔ML 원본 Feature 계약 테스트용 거래 한 건."""

from typing import Any


def valid_ml_raw_data() -> dict[str, Any]:
    """새 전처리가 요구하는 54개 원본 Feature를 반환한다."""
    ...
    return {
        ...
        "Transaction_Datetime": "2025-01-01 00:00:00",
        "Transaction_Amount": 3_995_050,
        "Channel": "mobile",
        ...
        "Distance": 0.0,
        "Time Difference": "0 days 00:00:00",
