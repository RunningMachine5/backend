...
전화번호 조작, 대출 신청 이후 한도 관련 행동, 평소보다 큰 금액의 송금, 본인 계좌가 아닌
수취계좌로의 이체가 함께 확인되면 고객 거래 진위를 우선 확인한다. 등록된 고객 연락처로
거래일시·금액·수취계좌를 안내하고, 금융회사·수사기관·대출상담사를 사칭한 연락과 추가 송금
요구가 있었는지 확인한다. 고객이 해당 거래를 인지하지 못하면 긴급 모니터링 검토 대상으로
전달하고 공식 피해 대응 절차를 안내할 준비를 한다.

고객이 사용하는 비밀번호·OTP·인증번호를 요구하지 않으며, 탐지 결과만으로 사기 피해를
확정하거나 계좌 제한을 자동 수행하지 않는다.
